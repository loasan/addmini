    ...
    return (
      <View className='list_searchInput'>
        <View className='shade'>
          ...
          <Input className='input' value={this.state.value} type='text' placeholder='请输入公司名称，仅支持英文' onConfirm={this.onclick_skip.bind(this)} onInput={this.inputHandler.bind(this)} confirmType='search' />
